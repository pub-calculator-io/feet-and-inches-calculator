...
function display_ci_feet_and_inches_calculator(){
    $page = 'index.html';
    return '<h2><a href="https://www.calculator.io/feet-and-inches-calculator/" target="_blank"><img src="' . esc_url(plugins_url('assets/images/icon-48.png', __FILE__ )) . '" width="48" height="48"></a> Feet and Inches Calculator</h2><div><iframe style="background:transparent; overflow: scroll" src="' . esc_url(plugins_url($page, __FILE__ )) . '" width="100%" frameBorder="0" allowtransparency="true" onload="this.style.height = this.contentWindow.document.documentElement.scrollHeight + \'px\';" id="ci_feet_and_inches_calculator_iframe"></iframe></div>';
}

add_shortcode( 'ci_feet_and_inches_calculator', 'display_ci_feet_and_inches_calculator' );